...
proc gofr {arr {molid top} {label mol} {seltext "all"}} {
  ...
  set sel [atomselect $molid "($seltext) and not (residue $res0 and name $name0)"]
...
after idle {
    ...
    ## Center the dendrimers com at the origin 
    set dend [atomselect top "fragment 0"] 
    set nframes [molinfo top get numframes]
    for {set i 0} {$i < $nframes} {incr i} {
      molinfo top set frame $i
      set com [measure center $dend weight mass]
      $dend moveby [vecinvert $com]
    }
    $dend delete
